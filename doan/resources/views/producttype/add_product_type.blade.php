...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        @include('partials.content-header', ['name' =>'ProductType', 'key'=>'Add'])
            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    ...
                    <div class="col-md-8">
                        ...
                        //                        }
                        //                        ?>
                        <form action="{{ route('product_type_save') }}" method="post">
                            {{ csrf_field() }}
                            <div class="form-group">
                                <label for="exampleFormControlInput1">Name ProductType</label>
                                <input type="text" class="form-control" id="" name="product_type_name" placeholder="Nhập thương hiệu">
                            </div>
{{--                            <div class="form-group">--}}
