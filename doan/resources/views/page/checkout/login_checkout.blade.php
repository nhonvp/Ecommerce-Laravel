                ...
                <div class="htc__login__register__wrap">
                    ...
                    <div id="login" role="tabpanel" class="single__tabs__panel tab-pane fade in active">
                       <h3 style="color: #ff4d4d"> <?php
                        ...
                        if($message){
                           ...
                           ?> </h3>
                        <form class="login" method="post" action="{{route('login_customer')}}">
                            {{ csrf_field() }}
                            <input type="text" placeholder="User Name*" name="login_name">
                        ...
                        <div class="htc__social__connect">
                            <a href="{{ route('admin_login') }}"><h2>Login Admin</h2></a>
                            <h2>Or Login With</h2>
                    ...
                    <div id="register" role="tabpanel" class="single__tabs__panel tab-pane fade">
                        <form action="{{route('add_customer')}}" method="post">
                            {{csrf_field()}}
                            <input type="text" placeholder="Name*" name="name_customer" required>
                            <input type="email" placeholder="Email*" name="email_customer" required>
                            <input type="password" placeholder="Password*" name="password_customer" required>
                            <input type="text" placeholder="Phone*" name="phone_customer" required>
